...
public class Definitions<TDefinitionType extends JsonDefinition> extends SimpleJsonResourceReloadListener
{
	...
	{
		//UpdateToolDefinitionDataPacket packet = new UpdateToolDefinitionDataPacket(keyedDefinitions);
	...
	protected void updateDataFromServer(@Nonnull Map<ResourceLocation, TDefinitionType> dataMap)
	{
		...
		//for (Entry<ResourceLocation,TDefinitionType> entry : definitions.entrySet()) {
